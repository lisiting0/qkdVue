/**
	...
	2019.3.20 修改事件采用handleEvent方式,修复滚动会触发click事件的bug
**/
...
;(function($,window,undefined){
	...
	myTouch=function(opt){
		...
		t.CANCEL_EV = t.hasTouch ? "touchcancel": "mousecancel";
	...
	myTouch.prototype={
		...
		_addDOMEvents:function(){
			...
			if(t.obj[0]){
				//console.log("绑定事件组")
				t.obj[0].addEventListener("click",this,{ passive: false, capture: true });
				t.obj[0].addEventListener(t.START_EV,this,{ passive: false, capture: false });
				t.obj[0].addEventListener(t.MOVE_EV,this,{ passive: false, capture: false });
				t.obj[0].addEventListener(t.END_EV,this,{ passive: false, capture: false });
				t.obj[0].addEventListener(t.CANCEL_EV,this,{ passive: false, capture: false });
		...
		_removeDOMEvents:function(){
			...
			if(t.obj[0]){
				//console.log("解绑事件组")
				t.obj[0].removeEventListener("click",this,{ passive: false, capture: true });
				t.obj[0].removeEventListener(t.START_EV,this,{ passive: false, capture: false });
				t.obj[0].removeEventListener(t.MOVE_EV,this,{ passive: false, capture: false });
				t.obj[0].removeEventListener(t.END_EV,this,{ passive: false, capture: false });
				t.obj[0].removeEventListener(t.CANCEL_EV,this,{ passive: false, capture: false });
			}
		},
			...
			switch (e.type){
				case 'click':
					if(t.x||t.y){
						...
						if(t.options.stopPropagation){
							t.setStopPropagation(e);
						}
					}
					break;
				case 'touchstart':
