    ...
    <div class="myscrollerdiv" :style="{height:myScrollerHeight+'px'}">
      <div class="tabs">
        ...
        <div class="tabs_content">
          ...
          <p><span>报名费：{{datingDetail.enrollFee}}乾坤币</span><span :class="payTypeCls">AA</span><span></span><span :class="payTypeCls2">你买单</span><span></span><span :class="payTypeCls1">我请客</span></p>
