...
export default {
  ...
  mounted () {
    ...
    this.myScrollerHeight = document.body.clientHeight-$(".header").height()-$(".menu").height()-(this.$store.state.isBrowser?0:0.75*parseInt(document.documentElement.style.fontSize))-3;
