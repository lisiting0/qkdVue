<template>
  <div class="main jy_all_top jy_bill">
    ...
    <myScroller :style="$store.state.isBrowser?'padding:1.65rem 0 0;':'padding:2.55rem 0 0;'" :noDataText="noDataText" :infinite="infinite" :refresh="refresh" :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" ref="myScroller" :showbg="showbg">
