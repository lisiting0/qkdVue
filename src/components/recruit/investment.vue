<template>
  <div class="main jy_all_top">
    ...
    <div class="image_div" :style="$store.state.isBrowser?'margin-top: 1.42rem;':''">
      <img :src="fillpath('staticAct/img/zs/zs_01.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_02.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_03.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_04.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_05.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_06.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_07.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_08.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_09.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_10.jpg')" alt="">
      <div class="form">
      ...
      <img :src="fillpath('staticAct/img/zs/zs_12.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_13.jpg')" alt="">
      <img :src="fillpath('staticAct/img/zs/zs_14.jpg')" alt="">
    </div>
  ...
  export default {
    ...
    mounted() {
		...
		if(this.$store.state.userInfo.id){
		  shareLink = shareLink + "__pid_"+this.$store.state.userInfo.jyNumber+ "_mytaskId_39";
		}
