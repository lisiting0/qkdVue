...
//import {hiddenAttr} from '@/plus/routerBack.js';
...
const RechargeiOS = r => require.ensure([], () => r(require('./components/user/recharge_iOS')), 'recharge_iOS');//充值ios
...
const VideoClass = r => require.ensure([], () => r(require('./components/video/videoClass')), 'videoClass');//视频课堂
...
const Nothing = r => require.ensure([], () => r(require('./components/other/nothing')), 'nothing');//404什么都没
*/
const Home = () => import('@/components/home/home.vue');
const User = () => import('@/components/user/user.vue');
const SafeHouse = () => import('@/components/user/safeHouse');
const SignOn = () => import('@/components/user/signOn');
const RecentVisit = () => import('@/components/user/recentVisit');
const Friend = () => import('@/components/friend/friend.vue');
const ChatWindow = () => import('@/components/friend/chatWindow');
const ChatWindowWeb = () => import('@/components/friend/chatWindowWeb');
const Love = () => import('@/components/affinity/love.vue');
const Love_old = () => import('@/components/affinity/love_old.vue');
const SetSort = () => import('@/components/affinity/setSort.vue');//筛选
const LoveList = () => import('@/components/affinity/loveList');
const Search = () => import('@/components/search/search.vue');
//const Jyjw = () => import('@/components/jyjw.vue');
const SendGift = () => import('@/components/user/sendGift.vue');
//const Star = () => import('@/components/star.vue');
//const Zmjy = () => import('@/components/home/zmjy.vue');
const Act = () => import('@/components/affinity/act.vue');
const ActJoinMember = () => import('@/components/affinity/actJoinMember.vue');//约会报名人员列表
const ActJoinMemberGl = () => import('@/components/affinity/actJoinMemberGl.vue');//普通约会报名人员列表
const ActOld = () => import('@/components/affinity/act_old.vue');
const ActScene = () => import('@/components/affinity/actScene.vue');//活动现场
const ActSceneNew = () => import('@/components/affinity/actSceneNew.vue');//活动现场(新版)
const BlindDate = () => import('@/components/blindDate/blindDate.vue');//相亲
const BlindDateNew = () => import('@/components/blindDate/blindDateNew.vue');//相亲(新版)
const Friendlist = () => import('@/components/friend/friendlist.vue');
const FansList = () => import('@/components/friend/fansList.vue');
const Message = () => import('@/components/friend/message.vue');
const MessageDetail = () => import('@/components/friend/messageDetail.vue');
//const Lable = () => import('@/components/friend/lable.vue');
const GroupChat = () => import('@/components/friend/groupChat.vue');
const Login = () => import('@/components/login/login.vue');
const ShareEnter = () => import('@/components/login/shareEnter.vue');
const Share = () => import('@/components/login/share.vue');
const LoginApp = () => import('@/components/login/loginApp.vue');
const Registered = () => import('@/components/login/registered.vue');
const FillInUserInfo = () => import('@/components/login/fillInUserInfo');
const RankingList = () => import('@/components/home/rankingList');
const RankingSignUp = () => import('@/components/home/rankingSignUp');
const Publish = () => import('@/components/publish/publish');
const Travel = () => import('@/components/publish/travel');
const Other = () => import('@/components/publish/other');
const Movie = () => import('@/components/publish/movie');
const UserDetail = () => import('@/components/user/userDetail');
const NearbyPeople = () => import('@/components/search/nearby/nearbyPeople');
const NearbyPeopleNew = () => import('@/components/search/nearby/nearbyPeopleNew');
const Nearbydate = () => import('@/components/search/nearby/nearbydate');
const Topline = () => import('@/components/search/topline/topline');
const Headline = () => import('@/components/search/topline/headline');//娇友头条
const Headline2 = () => import('@/components/search/topline/headline2');//娇友头条2
const ToplineDetail = () => import('@/components/search/topline/toplineDetail');
const Moments = () => import('@/components/search/moments/moments');
const SquareMoments = () => import('@/components/search/moments/squareMoments');//广场动态
const Comments = () => import('@/components/search/topline/comments');
const UserComment = () => import('@/components/search/topline/userComment');
const ForgetPassword = () => import('@/components/login/forgetPassword');
const ModifyPassword = () => import('@/components/login/modifyPassword');//修改密码
const MyFocus = () => import('@/components/user/myFocus');
const AddFriend = () => import('@/components/user/addFriend');
const MyComments = () => import('@/components/user/myComments');
const MyNewComments = () => import('@/components/user/myNewComments');//我的动态
const CommentDetail = () => import('@/components/user/commentDetail');
const MyOffer = () => import('@/components/user/myOffer');
const MyEvaluation = () => import('@/components/user/myEvaluation');
const PopularActivity = () => import('@/components/user/popularActivity');//人气活动
const AccountLevel = () => import('@/components/user/accountLevel');//账号等级
const GrowthValue = () => import('@/components/user/growthValue');//昨日成长值
const LevelPrivilege = () => import('@/components/user/levelPrivilege');//等级特权
const CertificationCenter = () => import('@/components/user/certificationCenter');//认证中心
const LevelDescription = () => import('@/components/user/levelDescription');//等级说明
const MembershipGrowthSystem = () => import('@/components/user/membershipGrowthSystem');//会员成长体系
const IdentityAuth = () => import('@/components/user/identityAuth');//身份认证
const VideoAuth = () => import('@/components/user/videoAuth');//视频认证
const HouseAuth = () => import('@/components/user/houseAuth');//房产认证
const CarAuth = () => import('@/components/user/carAuth');//车辆认证
const HealthyAuth = () => import('@/components/user/healthyAuth');//健康认证
const Recharge = () => import('@/components/user/recharge');//充值
const RechargeiOS = () => import('@/components/user/recharge_iOS');//充值ios
const UserInfo = () => import('@/components/user/userInfo');//个人信息查看
const ActInfo = () => import('@/components/affinity/actInfo');//群信息
const ActInfoEdit = () => import('@/components/affinity/actInfoEdit');//编辑资料
const ActMember = () => import('@/components/affinity/actMember');//群成员
const PrizeDraw = () => import('@/components/home/prizeDraw');//抽奖
const UserCenter = () => import('@/components/user/userCenter');//会员中心
const EarnCoin = () => import('@/components/user/earnCoin');//赚乾坤币
const Bill = () => import('@/components/user/bill');//账单
const Transaction = () => import('@/components/user/transaction');//账单2
const PrizeSelect = () => import('@/components/home/prizeSelect');//奖池选择
const ArticlePost = () => import('@/components/user/articlePost');//发布文章
const Setting = () => import('@/components/user/setting');//设置
const About = () => import('@/components/login/about');//设置
const Notice = () => import('@/components/user/notice');//通知
const AccountSecurity = () => import('@/components/user/accountSecurity');//账号安全
const Privacy = () => import('@/components/user/privacy');//隐私
const Bond = () => import('@/components/user/bond');//保证金
const Blacklist = () => import('@/components/user/blacklist');//黑名单
const Gift = () => import('@/components/user/gift');//我的礼物
const ModifyData = () => import('@/components/user/modifyData');//资料完善
const AddMoment = () => import('@/components/user/addMoment');//发朋友圈
const AddSquareMoment = () => import('@/components/user/addSquareMoment');//发广场动态
const BindLogin = () => import('@/components/user/bindLogin');//绑定/解绑第三方登录
const Shop = () => import('@/components/home/shop');//商城
const BindPhone = () => import('@/components/user/bindPhone');//换绑手机
const MyPrize = () => import('@/components/home/myPrize');//我的奖品
const MyBlindDate = () => import('@/components/blindDate/myBlindDate');//我的相亲
const RegistrationActivity = () => import('@/components/blindDate/registrationActivity');//相亲活动
const ActivityDetail = () => import('@/components/blindDate/activityDetail');//相亲活详情
const ActivityDetailStatic = () => import('@/components/blindDate/activityDetailStatic');//相亲活详情静态页面
const RegistrationStaff = () => import('@/components/blindDate/registrationStaff');//报名人员
const PublishBlindDate = () => import('@/components/blindDate/publishBlindDate');//发布相亲活动
const Preview = () => import('@/components/blindDate/preview');//预览相亲活动
const Putforward = () => import('@/components/user/putforward');//提现
const BlindDatePay = () => import('@/components/blindDate/blindDatePay');//相亲支付
const AddressMap = () => import('@/components/blindDate/addressMap');//地图
const Sign = () => import('@/components/blindDate/sign');//相亲签到
const AdminManage = () => import('@/components/blindDate/adminManage');//管理员设置
const VideoList = () => import('@/components/video/videoList');//视频
const VideoClass = () => import('@/components/video/videoClass');//视频课堂
const Agent = () => import('@/components/user/agent');//代理商
const Spread = () => import('@/components/user/spread');//合伙人
const SpreadPayList = () => import('@/components/user/spreadPayList');//商品列表
const QrCode = () => import('@/components/user/qrCode');//推广二维码
const IncomeDetail = () => import('@/components/user/incomeDetail');//明细
const QkdIntroduce = () => import('@/components/user/qkdIntroduce');//乾坤岛介绍
const BMap = () => import('@/components/other/bMap');//百度地图
const Help = () => import('@/components/user/help');//帮助与反馈
const QA = () => import('@/components/user/QA');//帮助与反馈
const PublishAppointment = () => import('@/components/publish/publishAppointment');//发布约会
const PublishDate = () => import('@/components/publish/publishDate');//发布普通约会
const Store = () => import('@/components/publish/store');//指定餐厅
const Apply = () => import('@/components/user/apply');//申请查看更多信息列表
const Favor = () => import('@/components/user/favor');//好感
const Feedback = () => import('@/components/extend/feedback');//红娘
const EnergyRanking = () => import('@/components/user/energyRanking');//排行榜
const Investment = () => import('@/components/recruit/investment');//招商新
const Raiders = () => import('@/components/recruit/raiders');//赚钱攻略
const OrdinaryInvestment = () => import('@/components/recruit/ordinaryInvestment');//普通与合伙人招商
const MyRedirect = () => import('@/components/home/myRedirect');//跳转
const IntroduceList = () => import('@/components/home/introduceList');//介绍列表
const Zhiyin = () => import('@/components/home/zhiyin');//指引
const Task = () => import('@/components/home/task');//任务宝
const TaskWxList = () => import('@/components/home/taskWxList');//我的邀请
const Exposure = () => import('@/components/exposure/exposure');//曝光台
const AddExposure = () => import('@/components/exposure/addExposure');//发曝光台
...
meta{
	...
	routerlink:true,//是否显示底部导航
}

**/
const routers = [
  {path: '/home',name: 'home',component: Home,meta:{title:"相约乾坤岛",redirect:true,deepth: 1,routerlink:true}},//首页
  ...
  {path: '/user',name: 'user',component: User,meta:{title:"我的",redirect:true,hideWxMenu:true,deepth: 5,routerlink:true}},//我的
  {path: '/safeHouse',name: 'safeHouse',component: SafeHouse,meta:{title:"娇友金屋",requireAuth:true,hideWxMenu:true,deepth: 8}},//娇友金屋
  {path: '/signOn',name: 'signOn',component: SignOn,meta:{title:"签到",requireAuth:true,hideWxMenu:true,deepth: 20}},//签到
  ...
  {path: '/friend',name: 'friend',component: Friend,meta:{title:"消息",requireAuth:true,hideWxMenu:true,deepth: 2,routerlink:true}},//消息
  {path: '/chatWindow',name: 'chatWindow',component: ChatWindow,meta:{title:"聊天窗口",requireAuth:true,hideWxMenu:true,deepth: 20}},//聊天窗口
  {path: '/chatWindowWeb',name: 'chatWindowWeb',component: ChatWindowWeb,meta:{title:"聊天窗口",requireAuth:true,hideWxMenu:true,deepth: 20}},//web端聊天窗口
  {path: '/love',name: 'love',component: Love,meta:{title:"邀约",redirect:true,deepth: 3,routerlink:true}},//娇缘
  ...
  {path: '/loveList',name: 'loveList',component: LoveList,meta:{title:"选缘",routerlink:true}},//选缘
  {path: '/actScene',name: 'actScene',component: ActScene,meta:{title:"活动现场",requireAuth:true,hideWxMenu:true}},//活动现场
  {path: '/actSceneNew',name: 'actSceneNew',component: ActSceneNew,meta:{title:"活动现场",requireAuth:true,hideWxMenu:true,deepth: 9}},//活动现场(新版)
  {path: '/blindDate',name: 'blindDate',component: BlindDate,meta:{title:"相亲",requireAuth:true,hideWxMenu:true}},//相亲
  {path: '/blindDateNew',name: 'blindDateNew',component: BlindDateNew,meta:{title:"相亲",requireAuth:true,hideWxMenu:true,deepth: 15}},//相亲(新版)
  {path: '/search',name: 'search',component: Search,meta:{title:"发现",redirect:true,deepth: 4,routerlink:true}},//发现
  {path: '/nearbyPeople',name: 'nearbyPeople',component: NearbyPeople,meta:{title:"附近的人",hideWxMenu:true,redirect:true,deepth: 8}},//附近的人
  ...
  {path: '/nearbydate',name: 'nearbydate',component: Nearbydate,meta:{title:"我的",hideWxMenu:true,redirect:true,routerlink:true}},//附近的约会
  ...
  {path: '/moments',name: 'moments',component: Moments,meta:{title:"娇友动态",redirect:true,deepth: 8}},//娇友动态
  ...
  {path: '/sendGift/:pagerouter',name: 'sendGift',component: SendGift,meta:{title:"购买礼物",requireAuth:true,hideWxMenu:true,deepth: 20}},//送礼
  //{path: '/star',name: 'star',component: Star,meta:{title:"约会明星"}},//约会明星
 // {path: '/zmjy',name: 'zmjy',component: Zmjy,meta:{title:"最美娇友"}},//最美娇友
  {path: '/act',name: 'act',component: Act,meta:{title:"约会详情",redirect:true,deepth: 9}},//活动详情
  ...
  {path: '/message',name: 'message',component: Message,meta:{title:"消息列表",requireAuth:true,hideWxMenu:true,deepth: 8}},//消息列表
  ...
  {path: '/modifyPassword',name: 'modifyPassword',component: ModifyPassword,meta:{title:"修改密码",requireAuth:true,hideWxMenu:true,deepth: 20}},//修改密码
  {path: '/myFocus',name: 'myFocus',component: MyFocus,meta:{title:"我的关注",requireAuth:true,hideWxMenu:true,deepth: 9}},//我的关注
  {path: '/addFriend',name: 'addFriend',component: AddFriend,meta:{title:"添加娇友",requireAuth:true,hideWxMenu:true}},//添加好友
  {path: '/myComments',name: 'myComments',component: MyComments,meta:{title:"我的动态",requireAuth:true,hideWxMenu:true,deepth: 20}},//我的动态
  ...
  {path: '/myOffer',name: 'myOffer',component: MyOffer,meta:{title:"我的邀约",requireAuth:true,hideWxMenu:true,deepth: 8}},//我的邀约
  ...
  {path: '/certificationCenter',name: 'certificationCenter',component: CertificationCenter,meta:{title:"认证中心",requireAuth:true,hideWxMenu:true,deepth: 8}},//认证中心
  ...
  {path: '/recharge',name: 'recharge',component: Recharge,meta:{title:"充值",requireAuth:true,hideWxMenu:true,deepth: 20}},//充值
  {path: '/RechargeiOS',name: 'RechargeiOS',component: RechargeiOS,meta:{title:"充值",requireAuth:true,hideWxMenu:true}},//充值ios

  {path: '/userInfo',name: 'userInfo',component: UserInfo,meta:{title:"个人信息查看",deepth: 9}},//个人信息查看
  {path: '/prizeDraw/:pagerouter',name: 'prizeDraw',component: PrizeDraw,meta:{redirect:true,title:"抽奖",deepth: 20}},//抽奖
  ...
  {path: '/earnCoin',name: 'earnCoin',component: EarnCoin,meta:{title:"赚乾坤币",redirect:true,deepth: 8}},//赚乾坤币
  {path: '/bill',name: 'bill',component: Bill,meta:{title:"账单",requireAuth:true,hideWxMenu:true,deepth: 9}},//账单
  ...
  {path: '/setting',name: 'setting',component: Setting,meta:{title:"设置",requireAuth:true,notRedirect:true,hideWxMenu:true,deepth: 8}},//设置
  {path: '/about',name: 'about',component: About,meta:{title:"关于",requireAuth:true,hideWxMenu:true,deepth: 20}},//设置
  {path: '/blacklist',name: 'blacklist',component: Blacklist,meta:{title:"黑名单",requireAuth:true,hideWxMenu:true,deepth: 20}},//黑名单
  {path: '/notice',name: 'notice',component: Notice,meta:{title:"通知",requireAuth:true,hideWxMenu:true,deepth: 20}},//通知
  {path: '/accountSecurity',name: 'accountSecurity',component: AccountSecurity,meta:{title:"账号安全",requireAuth:true,hideWxMenu:true,deepth: 9}},//账号安全
  ...
  {path: '/gift',name: 'gift',component: Gift,meta:{title:"我的礼物",requireAuth:true,hideWxMenu:true,deepth: 8}},//我的礼物
  {path: '/modifyData',name: 'modifyData',component: ModifyData,meta:{title:"资料完善",requireAuth:true,hideWxMenu:true,deepth: 20}},//资料完善
  ...
  {path: '/bindLogin',name: 'bindLogin',component: BindLogin,meta:{title:"绑定/解绑第三方登录",hideWxMenu:true,deepth: 20}},//绑定/解绑第三方登录
  {path: '/shop',name: 'shop',component: Shop,meta:{title:"商城"}},//商城
  {path: '/bindPhone',name: 'bindPhone',component: BindPhone,meta:{title:"换绑手机",requireAuth:true,hideWxMenu:true,deepth: 20}},//换绑手机
  {path: '/myPrize',name: 'myPrize',component: MyPrize,meta:{title:"换绑手机",requireAuth:true,hideWxMenu:true}},//换绑手机
  {path: '/myBlindDate',name: 'myBlindDate',component: MyBlindDate,meta:{title:"我的相亲",requireAuth:true,hideWxMenu:true,deepth: 8}},//我的相亲
  {path: '/registrationActivity',name: 'registrationActivity',component: RegistrationActivity,meta:{title:"相亲活动",redirect:true}},//相亲活动
  {path: '/activityDetail',name: 'activityDetail',component: ActivityDetail,meta:{title:"相亲活动详情",redirect:true,deepth: 9}},//相亲活动详情
  {path: '/activityDetailStatic',name: 'activityDetailStatic',component: ActivityDetailStatic,meta:{title:"相亲活动详情",redirect:true,deepth: 20}},//相亲活动详情静态页面
  ...
  {path: '/videoList',name: 'videoList',component: VideoList,meta:{title:"视频",isStatic:true,hideWxMenu:true,redirect:true}},//视频
  {path: '/videoClass',name: 'videoClass',component: VideoClass,meta:{title:"视频课堂",isStatic:true,isGetOpenId:true,hideWxMenu:true,redirect:true}},//视频课堂
  {path: '/agent',name: 'agent',component: Agent,meta:{title:"代理商",requireAuth:true,hideWxMenu:true,deepth: 8}},//代理商
  {path: '/spread',name: 'spread',component: Spread,meta:{title:"合伙人",redirect:true,deepth: 20}},//合伙人
  ...
  {path: '/bMap',name: 'bMap',component: BMap ,meta:{title:"百度地图"}},//百度地图
	{path: '/help',name: 'help',component: Help ,meta:{title:"帮助与反馈",redirect:true,deepth: 8}},//帮助与反馈
	{path: '/QA',name: 'QA',component: QA ,meta:{title:"问答",redirect:true,deepth: 20}},//问答
  ...
  {path: '/apply',name: 'apply',component: Apply ,meta:{title:"申请查看更多信息列表",requireAuth:true,hideWxMenu:true,deepth: 8}},//申请查看更多信息列表
  ...
  {path: '/energyRanking',name: 'energyRanking',component: EnergyRanking,meta:{title:"排行榜",redirect:true,deepth: 8}},//排行榜
  {path: '/investment',name: 'investment',component: Investment,meta:{title:"招商新",redirect:true}},//招商新
  {path: '/raiders',name: 'raiders',component: Raiders,meta:{title:"赚钱攻略",redirect:true,deepth: 20}},//赚钱攻略
  ...
  {path: '/zhiyin',name: 'zhiyin',component: Zhiyin,meta:{title:"指引",redirect:true}},//指引
	{path: '/task',name: 'task',component: Task,meta:{title:"任务宝",isStatic:true,isGetOpenId:true,redirect:true,hideWxMenu:true}},//任务宝
	{path: '/taskWxList',name: 'taskWxList',component: TaskWxList,meta:{title:"我的邀请",isStatic:true,isGetOpenId:true,redirect:true,hideWxMenu:true}},//我的邀请
	{path: '/exposure',name: 'exposure',component: Exposure,meta:{title:"曝光台",requireAuth:true,hideWxMenu:true,deepth: 8}},//曝光台
...
router.beforeEach(async (to,from,next)=>{
	...
	setTimeout(()=>{
		if(store.state.isBrowser&&store.state.forbidBack){//阻止页面返回(配合routerBack插件使用)
			...
			//window.history.pushState('forward', null, "#"+to.fullPath);
		}
		next();
	},0)
});
router.beforeResolve(async (to,from,next)=>{
  ...
  //Vue.nextTick(() => {//为获取正确的params
	...
	if(to.name=="404"||to.name=="nothing"){
		next();
		return false;
	}
	  if(!store.state.isLogin){
		...
		if(store.state.isWeixin&&!store.state.ownWxshare.includes(to.name)){//移到beforeResolve
			...
			let obj={
				title : to.meta.shareTitle||store.state.custom_config.defaultShareTile||'乾坤岛',
				desc : to.meta.shareDesc||store.state.custom_config.defaultShareContent||'一个安全、纯粹、高效的婚恋交友平台',
				link:shareLink,
		...
		if(!store.state.isWeixin&&to.name=="login"&&store.state.otherLogin.type != 'wx'&&store.state.otherLogin.type != 'qq'){//app的登录跳到loginApp 排除第三方登录
			next({
				path: '/loginApp',
		...
		if(params.query.isUnion&&!store.state.channel.isUnion){//记录渠道号
			store.commit("CHANGESTORE",{name:"channel",value:{
				isUnion:params.query.isUnion,
				jyNumber:params.query.jyNumber,
			}});
		}
		if(params&&params.query&&params.query.pid&&params.query.mytaskId){
			console.log("完成任务")
			try{
				server.taskFinish({qkh:params.query.pid,taskNumber:params.query.mytaskId,readonly:true});
			}catch (e) {
			}
		}
			...
			if(store.state.otherLogin.isBind){
				...
				try{
					...
					if(e.status==140017){//没有绑定账号
						...
						return false;
					}else if(e.status==140004||e.status==140002||e.status==140003){//特殊处理冻结
						next({name:"nothing",query:{hiddenBack:true}});
				...
				if(store.state.isLogin){
				  if(store.state.userInfo.silentState==1){
					Vue.$vux.confirm.show({
					  title: '温馨提示',
					  theme: 'android',
					  content: store.state.custom_config.openNotSeeMeInfo||'你已经开启了不允许别人看我,同时也不能查看其它用户的信息,需要关闭后才可以看其他用户的信息.',
					  confirmText: '去关闭',
					  onCancel () {
						if(!from.name){
						next({
        ...
        // silentState 0关 1开
			if(to.name=="userInfo"&&to.query.silentState!=0&&(!store.state.isLogin||to.query.id!=store.state.userInfo.id)){
				if(to.query.silentState==1){
				  Vue.$vux.toast.show({
					type: "text",
					text: store.state.custom_config.noSeeMyInfo||"对方已设置不允许查看Ta的个人信息",
					position: "middle",
					width: "auto",
				  });
				  next({name:"nothing"});
			...
			if(to.fullPath!=from.fullPath){//日志统计
				...
				let taskId={};//任务ID
				if(params.query.mytaskId){
					taskId={
						taskId:params.query.mytaskId
					}
				}
				let pid={};//分享人(乾坤号)
				if(params.query.pid){
				...
				let appChannel={};
				if(store.state.isApp&&!store.state.isiOSApp){//android 渠道号
					appChannel={//打包渠道号
						appChannel:store.state.appChannel
					};
				}
				let appInfo={};
				if(window.api){
					appInfo={
						connectionType:window.api.connectionType,//当前网络连接类型，如 2g、3g、4g、wifi 等
						operator:window.api.operator,//运营商名称,比如：中国移动，若未获取到则返回none
						deviceId:window.api.deviceId,//设备唯一标识
						appVersion:window.api.appVersion,//应用版本号
						systemType:window.api.systemType,//系统类型
					}
				}
				let version={//前端版本号
				...
				store.dispatch("dataLog",{
					...
					source:store.state.isWeixin?1:store.state.isiOSApp?4:store.state.isApp?store.state.appChannel:2,
					title:to.meta.title,
					info:JSON.stringify({...channel,...jyNumber,"URL":to.fullPath,...taskId,...pid,"sourceType":from.name?'站内':'站外',"source":from.name?from.fullPath:document.referrer?document.referrer:"直接访问","params":params,...userInfo,...appChannel,...version,...appInfo}),
					readonly:true
				});
			}
