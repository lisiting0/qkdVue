<template>
  <div class="shade" @click="close">
    <div class="popover" @click.stop="">
      <div class="usertitle">送给<span>{{name}}</span>:<shop v-if="showShop" :tag="'i'" :giftUserId="giftUserId" :giftUserName="name" class="toshop">去商城送礼</shop><i @click="close" class="iconfont">&#xe607;</i></div>
      <div class="mycontent">
