<template>
  <div class="main" @click="windowClick">
    ...
    <myScroller :style="$store.state.isBrowser?'padding:3.2rem 0 0;':'padding: 4.15rem 0 0;'" :infinite="infinite" :refresh="refresh" :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" ref="myScroller" :showbg="showbg">
      <div class="myscoll">
                  ...
                  <div class="comment_arr" v-for="(item,index) in listArr" :key="item.id">
                    <template v-if="active==1">
                      <div class="user border-bottom">
                        <i class="user_img" :style="item.jiaoyouUser?'background-image:url('+getFullPath(item.jiaoyouUser.headimgAttachmentId)+');':''" @click="toUserInfo(item.jiaoyouUser.id,item.jiaoyouUser.silentState)"></i>
                        <div>
                          <i class="news_icon"></i>
                    ...
                    <template v-if="active==2">
                      <div class="user">
                        <i class="user_img" :style="item.rUser?'background-image:url('+getFullPath(item.rUser.headimgAttachmentId)+');':''" @click="toUserInfo(item.rUser.id,item.rUser.silentState)"></i>
                        <div>
                          <i class="news_icon"></i>
                    ...
                    <template v-if="active==3">
                      <div class="user">
                        <i class="user_img" :style="item.user?'background-image:url('+getFullPath(item.user.headimgAttachmentId)+');':''" @click="toUserInfo(item.user.id,item.user.silentState)"></i>
                        <div>
