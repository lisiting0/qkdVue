<template>
  <div class="prizeDraw">
      ...
      <div class="prizeDraw-header">
        <div class="top">
          <a class="left" @click="back"><i class="iconfont">&#xe613;</i></a>
          <a class="right"></a>
        </div>
      </div>
      <div class="setting">
      ...
      <jqPrize v-if="changePrize" @endPrize="endPrize" @prizeRunning="prizeRunning" :groupId="groupId" :payBion="cost" :rate="rate" :imgPath="imgPath" @rules="rules"></jqPrize>
...
<script>
  ...
  import jqPrize from '../home/jqPrize.vue';
  ...
  export default {
    ...
    props: ['actDatingId','actChatNumber'],
    data() {
      return {
        changePrize:true,
        remarks:null,
