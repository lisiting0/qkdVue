...
<div class="main jy_all_top jy_transaction">
	...
	<dl class="jy_gift_list">
		...
		<dd>
			<myScroller :style="$store.state.isBrowser?'padding:2.75rem 0 0;':'padding:3.5rem 0 0;'" :infinite="infinite" :noDataText="noDataText" :refresh="refresh" :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" ref="myScroller">
