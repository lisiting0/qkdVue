  ...
  <div class="main">
    ...
    <div class="header">
      <div class="top">
        ...
        <a class="right"></a><p>私密资料请求通知</p>
      </div>
    </div>
    <myScroller :style="$store.state.isBrowser?'padding:1.32rem 0 0;margin-top:0.2rem':'padding:2.1rem 0 0;margin-top:0.2rem'" :infinite="infinite" :refresh="refresh" :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" ref="myScroller" :showbg="showbg">
      <div class="myscoll">
        <div class="content">
