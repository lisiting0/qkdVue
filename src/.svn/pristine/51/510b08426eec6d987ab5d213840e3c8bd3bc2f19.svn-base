    ...
    <div class="certificationCenter_con">
      <div class="certificationCenter_panel">
        <div class="link_panel">
          <a :class="{ok:userInfo.idStatus==1}"><i class="grzx_icon"></i></a>
        ...
        <div class="link_panel">
          <a :class="{ok:userInfo.videoStatus==1}"><i class="sprz_icon"></i></a>
      ...
      <div class="certificationCenter_panel">
        <div class="link_panel">
          <a :class="{ok:userInfo.carStatus==1}"><i class="ccrz_icon"></i></a>
        ...
        <div class="link_panel">
          <a :class="{ok:userInfo.houseStatus==1}"><i class="fcrz_icon"></i></a>
        ...
        <div class="link_panel">
          <a :class="{ok:userInfo.healthyStatus==1}"><i class="jkrz_icon"></i></a>
          <router-link :to="{name:'healthyAuth'}" tag="div" v-if="userInfo.healthyStatus==0 || userInfo.healthyStatus==3">
            <span>健康认证</span>
            <span>立即认证</span>
            <i class="iconfont">&#xe702;</i>
          </router-link>
          <div :class="{ok:userInfo.healthyStatus==1}" v-else>
            <span>健康认证</span>
            <span v-if="userInfo.healthyStatus==1">已认证</span>
            <span v-if="userInfo.healthyStatus==2">认证中</span>
          </div>
        </div >
      </div>
    </div>
