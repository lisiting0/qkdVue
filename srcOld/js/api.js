export const Fn={
	keepAliveObject:{
		"loveList":["act"],//活动列表
		"home":["act","userInfo","rankingList","love","friend","search","user","nearbyPeople","registrationActivity","prizeDraw","activityDetailStatic","nearbydate"],//首页
		...
		"nearbyPeople":["userInfo","chatWindowWeb","chatWindow","login","loginApp"],//附近的人
		"nearbydate":["act"],//附近邀约
		"rankingList":["rankingSignUp"],//最美娇友
		"myOffer":["act","actSceneNew"],//我的邀约
		"myFocus":["userInfo","chatWindow"],//我的粉丝等
		//"recentVisit":["userInfo"],//最近来访
		"myBlindDate":["activityDetail","blindDate","blindDateNew"],
		"registrationStaff":["userInfo"],
		"registrationActivity":["activityDetailStatic","blindDateNew","blindDate"],
	},
