<template>
  <div>
    ...
    <div class="main" key="main" v-if="pagerouter==='main'">
      ...
      <div class="header">
        <div class="top">
          <Back :back-one="true" class="left"><i class="iconfont">取消</i></Back><a @click="publish" class="right"><i class="iconfont">确定</i></a>{{datingTitles[datingThemes-1]==undefined?'其他':datingTitles[datingThemes-1]}}
        </div>
      </div>
        ...
        <div class="content">
          ...
          <div class="white" style="margin-top: 0.3rem;">
            ...
            <div class="flex" @click="selectDatingTitle">
              <div>{{datingThemes==99?'主题':'运动项目'}}</div><div><span>{{datingTitle===''?'选择主题':datingTitle}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            ...
            <div class="flex" @click="visibility = true">
              <div>约会时间</div><div><span>{{datetime===''?'选择时间':datetime}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            <group style="display: none">
          ...
          <div class="white" style="margin-top: 0.3rem;">
            ...
            <div class="flex content2">
              ...
              <div>
                ...
                <span :class="{active:payType===1}" @click="payType=1">我买单</span>
    ...
    <div class="main" key="myplace" v-if="pagerouter==='datingTitle'">
      <div class="header">
        <div class="top">
          <Back class="left"><i class="iconfont">&#xe613;</i></Back><a @click="confirm" class="right"><i class="iconfont">确定</i></a>邀约主题
        </div>
      </div>
      <div class="wrapper">
    ...
    computed: {
      ...
      checkObj:function(){
        return {
          ...
          datingTitle:this.datingTitle||this.datingTitles[this.datingThemes-1],
