  ...
  <div class="parent main">
      ...
      <div class="header">
        <div class="top">
          ...
          <myScroller :style="$store.state.isBrowser?'padding:1.39rem 0 0;':'padding:2.14rem 0 0;'" :noDataText="noDataText" :infinite="infinite" :refresh="refresh" :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" ref="myScroller">
		  <div class="myscoll">
		  <div class="content">
            <div class="title">
