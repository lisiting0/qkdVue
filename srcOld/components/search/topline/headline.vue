<template>
	<div class="main jy_all_top jy_headline">
		...
		<myScroller :style="$store.state.isBrowser?'padding:1.39rem 0 0;':'padding:2.14rem 0 0;'" :touchmove="touchmove" :infinite="infinite" :refresh="refresh" :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" ref="myScroller">
