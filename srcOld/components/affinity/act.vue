...
<div class="main jy_all_top  jy_new_act jy_opacity_top">
	...
	<div class="header" :class="{backgroundColorheader:opacity>0.2}" :style="{'background-color':'rgba(255,255,255,'+opacity+')'}">
		<div class="top">
			...
			<a class="right" @click="clickShare"><i class="iconfont">&#xe679;</i></a><p>详情</p>
		</div>
	</div>
	<myScroller style="padding: 0 0 1rem;"  :loadRefresh="loadRefresh" :loadInfinite="loadInfinite" :bouncing="!1" :touchmove="touchmove" ref="myScroller">
	...
	<div class="jy_new_act_b" v-if="datingDetail">
		...
		<div class="jy_new_act_block" v-if="enrollCount&&enrollCount>0">
			<div class="jy_new_act_bmList_wrap" :class="{jy_new_act_bmList_blur:datingDetail.isCandidate!=1}">
				<p class="jy_new_act_t"><router-link tag="i" :to="{name:'actJoinMember',query:{id:id}}">&#xe702;</router-link>已报名({{enrollCount}})</p>
