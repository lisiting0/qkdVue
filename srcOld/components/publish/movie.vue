        ...
        <div class="content">
          ...
          <div class="white">
            ...
            <div class="flex" @click="visibilityData = true">
              <div>观影地点</div><div><span>{{myplace===''?'选择地点':myplace}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            <div class="flex">
              <div>影院地址</div><div><input class="datingTitle" v-model="datingLocation" placeholder="请输入影院地址"/></div>
            </div>
            <div class="flex" @click="visibility = true">
              <div>观影时间</div><div><span>{{datetime===''?'选择时间':datetime}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
          ...
          <div class="white" style="margin-top: 0.3rem;">
            ...
            <!--<div class="flex content2">-->
              ...
              <!--<div>-->
                ...
                <!--&lt;!&ndash;<input type="text" v-model="contentRemark" placeholder="请填写具体要求"/>&ndash;&gt;-->
              <!--</div>-->
            <!--</div>-->
          </div>
    ...
    computed: {
      ...
      checkObj:function(){
        return {
          ...
          datingLocation:this.datingLocation,
