        ...
        <div class="content">
          ...
          <div class="white" style="margin-top: 0.3rem;">
            ...
            <div class="flex" @click="visibilityData = true">
              <div>目的地</div><div><span>{{myplace===''?'选择地点':myplace}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            <div class="flex" @click="visibility = true">
              <div>出发时间</div><div><span>{{datetime===''?'选择时间':datetime}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            <div class="flex" @click="visibility1 = true">
              <div>预计时间</div><div><span>{{tripTimeLengthName===''?'请选择':tripTimeLengthName}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            <div class="flex" @click="visibility2 = true">
              <div>出行方式</div><div><span>{{tripModeName===''?'请选择':tripModeName}}</span><i class="iconfont">&#xe702;</i></div>
            </div>
            <group style="display: none">
          ...
          <div class="white" style="margin-top: 0.3rem;">
            ...
            <div class="flex content2">
              ...
              <div>
                ...
                <span :class="{active:takepeople===1}" @click="takepeople=1">允许带人</span>
