...
import Luck from '@js/luck.js'
  export default {
    name: 'luck',
	props:["baomingUser","luckList","isManage","startLuck","datingId"]
	,
    data () {
		return {
			luckIndex:-1,
