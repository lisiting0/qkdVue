...
<script>
  export default {
    ...
    created() {
      ...
      this.initRadius = 18 * this.ratio/2
      this.minHeadRadius = 12 * this.ratio/2
      this.minTailRadius = 5 * this.ratio/2
      this.initArrowRadius = 10 * this.ratio/2
      this.minArrowRadius = 6 * this.ratio/2
      this.arrowWidth = 3 * this.ratio/2
      this.maxDistance = 40 * this.ratio/2
      this.initCenterX = 25 * this.ratio/2
      this.initCenterY = 25 * this.ratio/2
      this.headCenter = {
        x: this.initCenterX,
        y: this.initCenterY
      }
